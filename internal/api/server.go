...
func CreateServer() *http.ServeMux {
	...
	mux.HandleFunc("/api/health", rateLimitMiddleware(healthHandler))
	mux.HandleFunc("/api/dns", rateLimitMiddleware(dnsHandler))
	mux.HandleFunc("/api/blacklist", rateLimitMiddleware(blacklistHandler))
	mux.HandleFunc("/api/smtp", rateLimitMiddleware(smtpHandler))
	mux.HandleFunc("/api/auth", rateLimitMiddleware(authHandler))
	mux.HandleFunc("/api/network/ping", rateLimitMiddleware(pingHandler))
	mux.HandleFunc("/api/network/traceroute", rateLimitMiddleware(tracerouteHandler))
	mux.HandleFunc("/api/network/whois", rateLimitMiddleware(whoisHandler))
	return mux
}
